...
public class game {
    ...
    public List<ICrosser> rightBankCrossers1=new ArrayList<>();
    public List<ICrosser> leftBankCrossers1=new ArrayList<>();
    public List<ICrosser> boatRiders1=new ArrayList<>();

    public List<ICrosser> rightBankCrossers2=new ArrayList<>();
    public List<ICrosser> leftBankCrossers2=new ArrayList<>();
    public List<ICrosser> boatRiders2=new ArrayList<>();
    ...
    public void start(Stage primaryStage) throws Exception {
        ...
        scene3.getStylesheets().add("st.css");
        ...
        sceneS3.getStylesheets().add("st.css");
        ...
        goAhead11.setOnAction(event -> {
            if(s2.isvalid(rightBankCrossers1,leftBankCrossers1,boatRiders1)==true) {
                s2.mover(gc2,"raft");
        ...
        goAhead3.setOnAction(event -> {
            if(s3.isvalid(rightBankCrossers2,leftBankCrossers2,boatRiders2)==true) {
                s3.mover(gc3,"raft");
